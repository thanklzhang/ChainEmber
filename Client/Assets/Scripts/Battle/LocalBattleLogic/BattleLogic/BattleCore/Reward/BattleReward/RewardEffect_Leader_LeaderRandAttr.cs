...
{
    //给队长加随机属性
    public class RewardEffect_Leader_LeaderRandAttr : BaseBattleRewardEffectOption
    {
        //最终结果奖励
        ...
        public override void OnGain(BattlePlayer gainer)
        {
            ...
            // arg.attrGroupType = EntityAttrGroupType.BattleReward;
            // arg.attrGroupConfigId = this.attrGroupId;
            // this.attrs = this.player.AddAttrToLeader(arg);
            ...
            gainer.entity.AddAttrs(EntityAttrGroupType.BattleReward, attrs);
        }
